...
<div class="w-50">
    ...
    <hr>
    <div style="width:650px; margin:0px auto; text-align:left; background: #ffffff; font-size:12px; line-height:24px;">zs
        <p>
            マコトクリエイション （以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
        </p>
        <p>
            第1条（個人情報）
        </p>
        ...
        <br />
            住所：901-1116  沖縄県島尻郡南風原町照屋２４８−１７　Karii201
        <br />
            運営：マコトクリエイション
        <br />
            Eメールアドレス：arakakiconsul@gmail.com
        </p>
</div>
